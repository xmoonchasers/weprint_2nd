...
$query1=mysqli_query($conn,"SELECT students.*
                        FROM schedule
                        JOIN students ON CONCAT(students.year, students.section) = schedule.year_section
...
?>
            ...
            <!-- Earnings (Monthly) Card Example -->
             <?php 
$query1=mysqli_query($conn,"SELECT schedule.*
                        FROM schedule
                        JOIN students ON CONCAT(students.year, students.section) = schedule.year_section
                        WHERE schedule.instructor_id = '$id'");                       
...
?>
            ...
            <?php 
$query1=mysqli_query($conn,"SELECT attendance.*
                        FROM attendance
                        join schedule On schedule.id = attendance.schedule_id
                        JOIN students ON CONCAT(students.year, students.section) = schedule.year_section
                        WHERE schedule.instructor_id = '$id'");                       
