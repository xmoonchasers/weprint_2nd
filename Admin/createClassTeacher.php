...
if(isset($_POST['save'])){
  ...
  $dateCreated = date("Y-m-d");
    ...
    $query=mysqli_query($conn,"INSERT into tblclassteacher(firstName,lastName,emailAddress,password,phoneNo,dateCreated, pin, fingerprint) 
    value('$firstName','$lastName','$emailAddress','$sampPass_2','$phoneNo','$dateCreated','$pin', '$fingerprint')");
                  ...
                  <form method="post">
                   <div class="form-group row mb-3">
                     ...
                     <div class="form-group row mb-3">
                      ...
                      <input type="text" class="form-control" name="password" value="" id="exampleInputFirstName" >
                        </div>
                    </div>
                    ...
                    <div class="form-group row mb-3">
                      ...
                      <input type="text" class="form-control" required name="pin" value="<?php echo $row['pin'];?>" id="exampleInputFirstName" >
                        </div>
                        <div class="col-xl-3">
                        <label class="form-control-label">Fingerprint ID<span class="text-danger ml-2">*</span></label>
                      <input type="text" class="form-control" required name="fingerprint" value="<?php echo $row['fingerprint'];?>" id="exampleInputFirstName" >
                        </div>
                    </div>
                      <?php
                    if (isset($Id))
